      ...
      <v-col cols="12" md="10" lg="8">
        <v-card class="pa-8" elevation="0">
          ...
          <div v-else class="text-center py-8">
            ...
            <p class="text-body-2 text-medium-emphasis">
              Enter a search term above to find content across the accessibility portal
            </p>
          </div>
        </v-card>
      </v-col>
...
useSeoMeta({
  ...
  description: 'Search the ICJIA Accessibility Portal for accessibility resources and information',
})
</script>
